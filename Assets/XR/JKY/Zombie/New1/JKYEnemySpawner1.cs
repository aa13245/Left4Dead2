...
public class JKYEnemySpawner1 : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        StartCoroutine(SpawnEnemiesAfterDelay(20, 10));
        // 두 번째 웨이브: 30초 후에 25명 스폰
        StartCoroutine(SpawnEnemiesAfterDelay(50, 25)); // 20초 + 30초 = 50초 후
        // 세 번째 웨이브: 45초 후에 30명 스폰
        StartCoroutine(SpawnEnemiesAfterDelay(95, 30)); // 50초 + 45초 = 95초 후
    }
